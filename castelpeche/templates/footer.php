...
<footer>
    <div class="foot">
        <div class="horaire">
            ...
            <p> Lundi (pendant la saison) </p>
            <p> de 9H à 12H et de 14H à 18H </p>
            <p> Du mardi au Samedi </p>
            <p> De 9H à 12H et de 14H à 19H </p>
            <p> Les jours fériés (pendant la saison)</p>
            <p> De 10H à 12H</p>
        </div>
        <div class="contact">
            <h2>Contact</h2>
            <p>Zone Commerciale 02400</p>
            <P>Essômes Sur Marne </P>
            <p>Tél/Fax: <a class=link href="tel:+33323699873" target:_blank>03.23.69.98.73</a> </p>
            <p>E-mail:<a class=link href="mailto:castelpeche@orange.fr">castelpeche@orange.fr</a></p>
        </div>
        <div class="footlogo">
