...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/./php/db/recupeArticles.php') ?>
...
?>
    <article class="carnafull">
        ...
        <div class="h3p">
            ...
            ?>
                <a href="./updateForm.php?id=<?php echo $art["id"] ?>" class="update"> Modifier</a> <!-- Je récupére l'id de l'article pour le modifier -->
